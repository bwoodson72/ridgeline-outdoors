...
<section id="contact" class="bg-surface-alt py-section">
	<Container>
		<div class="grid grid-cols-1 gap-12 lg:grid-cols-2 lg:gap-16">
				...
				<div class="mt-10 space-y-5">
					...
					<div class="flex items-start gap-4">
						...
						<div>
							...
							<a
								...
								class="text-sm text-text-secondary transition-colors hover:text-brand"
							>
								{contactEmail}
							</a>
						</div>
					...
					{#if address}
						<div class="flex items-start gap-4">
							...
							<div>
								<p class="text-sm font-medium text-text-primary">Office</p>
			...
			<!-- Right: form card -->
			<div class="rounded-xl border border-border bg-surface p-8 shadow-elevated">

				{#if formState === 'success'}
					<!-- Success state -->
					<div class="flex flex-col items-center py-12 text-center">
						<div
							class="mb-6 flex h-20 w-20 items-center justify-center rounded-full bg-green-50"
						>
							<svg
								xmlns="http://www.w3.org/2000/svg"
								width="40"
						...
						<p class="text-sm leading-relaxed text-text-secondary">
							A Summit estimator will reach out within one business day to confirm your
							appointment.
						</p>
					</div>
					...
					<form onsubmit={handleSubmit} novalidate class="space-y-5">
						...
						<div>
							...
							<textarea
								...
								bind:value={message}
								rows={5}
								placeholder="Tell us about your roofing project or concern..."
								aria-required="true"
